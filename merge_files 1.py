...
for component in file1_dict['components']:
	if component['key'] in path_revisions_dict.keys():	
		output_json_array_element = {}
		output_json_array_element['path'] = component['key']
		output_json_array_element['revisions'] = path_revisions_dict[component['key']]
